...
void TreeGen::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "order", PROPERTY_HINT_RANGE, "2.0,50.0,0.01"), "set_order", "get_order");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "une", PROPERTY_HINT_RANGE, "0.0,2.0,0.01"), "set_une", "get_une");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "sideAngleB", PROPERTY_HINT_RANGE, "0.0,2.0,0.01"), "set_sideAngleB", "get_sideAngleB");
	ADD_PROPERTY(PropertyInfo(Variant::PACKED_VECTOR3_ARRAY, "sidangle", PROPERTY_HINT_NONE, ""), "set_sidangle", "get_sidangle");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "rotation", PROPERTY_HINT_RANGE, "0.0,1.0,0.01"), "set_rotation", "get_rotation");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "distA", PROPERTY_HINT_RANGE, "0.0,1.0,0.01"), "set_distA", "get_distA");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "wor", PROPERTY_HINT_RANGE, "-2.0,2.0,0.01"), "set_wor", "get_wor");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "top_radius", PROPERTY_HINT_RANGE, "0.0,1.0,0.01"), "set_top_radius", "get_top_radius");
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "bottom_radius", PROPERTY_HINT_RANGE, "-2.0,2.0,0.01"), "set_bottom_radius", "get_bottom_radius");
...
void TreeGen::set_sidangle(PackedVector3Array sidangle) {
...
PackedVector3Array TreeGen::get_sidangle() const {
	return sidangle;
}
...
Dictionary TreeGen::gen(float w,float h,Transform3D home) const{
	...
	Transform3D az = home.translated((Vector3(0.0,h,0.0)));
	...
	Transform3D t = home.translated(Vector3(0.0,h/2,0.0)) * IDENTITY.scaled(Vector3(w,h,w));
...
void TreeGen::_create_mesh_array(Array &p_arr, Dictionary tr) const {
	...
	for(int cr = 0; cr < tree.size(); cr++){
		...
		Transform3D par = n*IDENTITY.translated(Vector3(0.0,0.5,0.0));
